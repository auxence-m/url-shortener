...
func handlePostRequest(w http.ResponseWriter, r *http.Request) {
	...
	// Write into firestore, slugs are documents id
...
func handleGetRequest(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		logger.Printf("Error getting document from Firestore: %v", err)
		http.Error(w, "Failed to get the corresponding url", http.StatusNotFound)
		return
	}
